...
class InterstitialAdsManager {
  ...
  static final InterstitialAdsManager _instance = InterstitialAdsManager();

  static InterstitialAdsManager getInstance() {
    return _instance;
  }
  ...
  void showInterstitialAds({
    ...
    InterstitialAd.load(
      adUnitId: idAds ?? AdHelper().interstitialAdUnitId,
